...
var tpl = template.Must(template.New("generated").
	...
	Parse(`
// Code generated by github.com/wetterj/dataloaden, DO NOT EDIT.
...
import (
    ...
    "gitlab.com/SpringboardVR/content-api/cacher"
...
type {{.Name}}JSONCache struct {
	data *cacher.JSONCache
}

func New{{.Name}}JSONCache(c *cacher.JSONCache) *{{.Name}}JSONCache {
	return &{{.Name}}JSONCache{
		data: c,
	}
}
